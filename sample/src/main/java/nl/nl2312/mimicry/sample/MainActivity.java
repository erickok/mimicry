package nl.nl2312.mimicry.sample;

import nl.nl2312.mimicry.library.MimicryAdapter;
import nl.nl2312.mimicry.library.MimicryAdapter.OnMimicryItemClickedListener;
import nl.nl2312.mimicry.sample.adapters.ImagesAdapter;
import nl.nl2312.mimicry.sample.adapters.MergeAdapter;
import nl.nl2312.mimicry.sample.adapters.ViewHolderAdapter;
...
public class MainActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Second in the list is a grid of featured images
		MimicryAdapter imagesAdapter = new MimicryAdapter(this, 3,
				new ImagesAdapter(this, FEATURED, AUTHORS));
		...
		// Finally add a normal list of items
		combined.addAdapter(new ArrayAdapter<String>(this,
				android.R.layout.simple_list_item_1, CHEESES));

		setListAdapter(combined);

		// NOTE The MimicryAdapter needs its own item click listener
		imagesAdapter.setOnMimicryItemClicked(onFeaturedItemClicked);
	...
	private OnMimicryItemClickedListener onFeaturedItemClicked = new OnMimicryItemClickedListener() {
		@Override
		public void onItemClicked(Object item) {
			// The item here is the object that the wrapped images adapter
			// returns: a String in this case
			Toast.makeText(MainActivity.this, (String) item, Toast.LENGTH_SHORT)
					.show();
		}
	};

	public static final int[] FEATURED = { R.drawable.cheese_feta,
			R.drawable.cheese_gouda, R.drawable.cheese_limburger,
			R.drawable.cheese_mozzarella, R.drawable.cheese_tommedesavoie,
			R.drawable.cheese_valencay };

	public static final String[] AUTHORS = {
			"Feta, Dominik Hundhammer, 28 January 2005",
			"Gouda Pikant, Dominik Hundhammer, 25 May 2004",
			"Limburger, Markus Hagenlocher, 18 March 2006",
			"Mozzarella, Jon Sullivan, 29 April 2006",
			"Tomme de Savoie, Francine Sautret, 29 April 2005",
			"Valencay, DocteurCosmos, 23 May 2010" };

	public static final String[] CHEESES = { "Abbaye de Belloc",
